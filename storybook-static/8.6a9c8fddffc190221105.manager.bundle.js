/*! For license information please see 8.6a9c8fddffc190221105.manager.bundle.js.LICENSE.txt */
    ...
    943: function(module, __webpack_exports__, __webpack_require__) {
            ...
            if (null !== node) {
              if ((index++, 1 === node.nodeType)) {
                ...
                if (data.indexOf(marker) >= 0) {
                  ...
                  '' === strings[lastIndex]
                    ? (parent.insertBefore(createMarker(), node), nodesToRemove.push(node))
      ...
      function removeNodesFromTemplate(template, nodesToRemove) {
        ...
        for (; walker.nextNode(); ) {
          ...
          for (
            node.previousSibling === currentRemovingNode && (currentRemovingNode = null),
            ...
            (part.index = null !== currentRemovingNode ? -1 : part.index - removeCount),
      ...
      class template_instance_TemplateInstance {
        ...
        _clone() {
          ...
          return (
            isCEPolyfill && (document.adoptNode(fragment), customElements.upgrade(fragment)),
            fragment
          );
        }
      }
      ...
      class template_result_TemplateResult {
        ...
        getHTML() {
          ...
          for (let i = 0; i < l; i++) {
            ...
            isCommentBinding =
              (commentOpen > -1 || isCommentBinding) && -1 === s.indexOf('--\x3e', commentOpen + 1);
      ...
      const isPrimitive = (value) =>
        ...
        isIterable = (value) => Array.isArray(value) || !(!value || !value[Symbol.iterator]);
      class AttributeCommitter {
        ...
        _getValue() {
          ...
          for (let i = 0; i < l; i++) {
            ...
            if (void 0 !== part) {
              const v = part.value;
              if (isPrimitive(v) || !isIterable(v)) text += 'string' == typeof v ? v : String(v);
              else for (const t of v) text += 'string' == typeof t ? t : String(t);
            }
          }
      ...
      class parts_AttributePart {
        ...
        setValue(value) {
          value === noChange ||
            ...
            ((this.value = value), isDirective(value) || (this.committer.dirty = !0));
        }
        commit() {
      ...
      class parts_NodePart {
        ...
        __commitText(value) {
          const node = this.startNode.nextSibling,
            valueAsString =
              'string' == typeof (value = null == value ? '' : value) ? value : String(value);
        ...
        __commitIterable(value) {
          ...
          partIndex < itemParts.length &&
            ((itemParts.length = partIndex), this.clear(itemPart && itemPart.endNode));
        }
      ...
      class PropertyCommitter extends AttributeCommitter {
        constructor(element, name, strings) {
          super(element, name, strings),
            (this.single = 2 === strings.length && '' === strings[0] && '' === strings[1]);
        }
        _createPart() {
      ...
      class parts_EventPart {
        ...
        commit() {
          ...
          const newListener = this.__pendingValue,
            ...
            shouldAddListener =
              null != newListener && (null == oldListener || shouldRemoveListener);
          shouldRemoveListener &&
      ...
      const defaultTemplateProcessor = new (class default_template_processor_DefaultTemplateProcessor {
      ...
      const lit_html_html = (strings, ...values) =>
          new template_result_TemplateResult(strings, values, 'html', defaultTemplateProcessor),
        svg = (strings, ...values) =>
          new template_result_SVGTemplateResult(strings, values, 'svg', defaultTemplateProcessor),
      ...
      const shadyTemplateFactory = (scopeName) => (result) => {
        ...
        prepareTemplateStyles = (scopeName, renderedDOM, template) => {
          ...
          if (0 === length)
            return void window.ShadyCSS.prepareTemplateStyles(templateElement, scopeName);
          ...
          if (window.ShadyCSS.nativeShadow && null !== style)
            renderedDOM.insertBefore(style.cloneNode(!0), renderedDOM.firstChild);
          else if (template) {
            content.insertBefore(condensedStyle, content.firstChild);
      ...
      const defaultConverter = {
        ...
        notEqual = (value, old) => old !== value && (old == old || value == value),
      ...
      class UpdatingElement extends HTMLElement {
        ...
        static getPropertyOptions(name) {
          return (
            (this._classProperties && this._classProperties.get(name)) || defaultPropertyDeclaration
          );
        }
        static finalize() {
        ...
        static _propertyValueFromAttribute(value, options) {
          const type = options.type,
            ...
            fromAttribute = 'function' == typeof converter ? converter : converter.fromAttribute;
        ...
        static _propertyValueToAttribute(value, options) {
          ...
          return ((converter && converter.toAttribute) || defaultConverter.toAttribute)(
            value,
            type
          );
        }
        ...
        _propertyToAttribute(name, value, options = defaultPropertyDeclaration) {
          ...
          if (void 0 !== attr) {
            ...
            (this._updateState = 8 | this._updateState),
              null == attrValue ? this.removeAttribute(attr) : this.setAttribute(attr, attrValue),
          ...
          if (void 0 !== name) {
            ...
            (options = options || ctor.getPropertyOptions(name)),
              ctor._valueHasChanged(this[name], oldValue, options.hasChanged)
                ? (this._changedProperties.has(name) || this._changedProperties.set(name, oldValue),
                  !0 !== options.reflect ||
        ...
        performUpdate() {
          ...
          try {
            (shouldUpdate = this.shouldUpdate(changedProperties)),
              shouldUpdate ? this.update(changedProperties) : this._markUpdated();
          } catch (e) {
            throw ((shouldUpdate = !1), this._markUpdated(), e);
          }
          shouldUpdate &&
            (1 & this._updateState ||
              ((this._updateState = 1 | this._updateState), this.firstUpdated(changedProperties)),
      ...
      const standardProperty = (options, element) =>
        'method' === element.kind && element.descriptor && !('value' in element.descriptor)
        ...
        static _getUniqueStyles() {
          ...
          if (Array.isArray(userStyles)) {
            const addStyles = (styles, set) =>
                styles.reduceRight(
                  (set, s) => (Array.isArray(s) ? addStyles(s, set) : (set.add(s), set)),
                  set
                ),
      ...
      (lit_element_LitElement.finalized = !0),
        (lit_element_LitElement.render = (result, container, options) => {
          ...
          const scopeName = options.scopeName,
            ...
            needsScoping =
              compatibleShadyCSSVersion && 11 === container.nodeType && !!container.host,
            firstScopeRender = needsScoping && !shadyRenderSet.has(scopeName),
            renderContainer = firstScopeRender ? document.createDocumentFragment() : container;
          if (
      ...
      const ErrorMessage = ({ title: title, children: children }) => lit_html_html`
...
`,
            ...
            void 0 === previousStyleProperties &&
              ...
              previousStyleProperties.forEach((name) => {
                name in styleInfo ||
                  ...
                  -1 === name.indexOf('-') ? (style[name] = null) : style.removeProperty(name));
              });
          ...
          updated(changedProperties) {
            super.updated(changedProperties),
              changedProperties.has('selectedNode') &&
                this.dispatchEvent(
                  new CustomEvent('nodeselect', { detail: { selectedNode: this.selectedNode } })
                );
          }
        }
        return (
                  ...
                  (ev) => {
                    if (this.isMovable)
                      if ((ev.preventDefault(), ev.ctrlKey)) {
                        ...
                        this.scale *= 1 - deltaY / (0.5 * (1e3 - this.zoomSpeed));
              ...
              this.addEventListener('gesturestart', (ev) => {
                ...
                (this.onmousedown = () => {
                  __classPrivateFieldGet(this, _isDragModeOn) &&
                    ...
                    (this.onmousemove = ({ movementX: movementX, movementY: movementY }) => {
            ...
            updated(changedProperties) {
              super.updated(changedProperties),
                changedProperties.has('scale') &&
                  this.dispatchEvent(
                    new CustomEvent('scalechange', { detail: { scale: this.scale } })
                  ),
                (changedProperties.has('panX') || changedProperties.has('panY')) &&
                  this.dispatchEvent(
                    new CustomEvent('positionchange', { detail: { x: this.panX, y: this.panY } })
                  );
            }
          }
          return (
                  ...
                  isXIntersecting
                    ...
                    : {
                        ...
                        bisector: isYIntersecting
                          ...
                          : [
                              { x: isALeft ? b.right : b.left, y: selectedCenter.y },
                              { x: isALeft ? b.right : b.left, y: isABelow ? b.bottom : b.top }
                            ]
                      },
                  isYIntersecting
                    ? null
                    : {
                        ...
                        bisector: isXIntersecting
                          ...
                          : [
                              { y: isABelow ? b.bottom : b.top, x: selectedCenter.x },
                              { y: isABelow ? b.bottom : b.top, x: isALeft ? b.right : b.left }
                            ]
                      }
                ].filter((x) => !!x);
  ...
  `;
              ...
              ...guides.map((guide) =>
                (({ guide: guide, reverseScale: reverseScale, fontSize: fontSize }) => {
                  const xLength = Math.abs(guide.points[0].x - guide.points[1].x),
                    yLength = Math.abs(guide.points[0].y - guide.points[1].y);
                  ...
                  const text = round(Math.max(xLength, yLength)).toString(10),
                    ...
                    cx = x + width / 2,
                    transformOrigin = xLength > yLength ? `${cx} ${y}` : `${x} ${y + fontSize / 2}`;
                  return svg`
  ...
  `;
        ...
        `;
      var copy_to_clipboard = __webpack_require__(209);
...
`,
      ...
      class Gradient {
        ...
        get cssGradientArray() {
          return this.colorObjects.map(
            (color, index) => color + ' ' + this.floatToPercent(this.colors[index].position)
          );
        }
        get cssColor() {
        ...
        constructor(node) {
          ...
          if (
            ...
            node.rectangleCornerRadii &&
              (this.borderRadius =
                node.rectangleCornerRadii.filter((radius) => radius === node.cornerRadius).length <
                4
            ...
            const color =
              ...
              (null === (_b = node.background) || void 0 === _b ? void 0 : _b[0].color);
            this.background = extractColorStyle(color);
          }
          const fillColor = null === (_c = node.fills) || void 0 === _c ? void 0 : _c[0];
          if (
            (fillColor &&
              !1 !== fillColor.visible &&
              ('TEXT' === node.type
            ...
            const { offset: offset, radius: radius, color: color } = node.effects[0];
            (this.boxShadowColor = extractColorStyle(color)),
              (this.boxShadow = `${(null == offset ? void 0 : offset.x) || 0}px ${(null == offset
                ? void 0
                : offset.y) || 0}px 0 ${radius} ${this.boxShadowColor}`);
          }
        }
        getStyles() {
          return [
            ...
            this.borderRadius && { property: 'border-radius', value: this.borderRadius },
            this.backgroundImage && { property: 'background-image', value: this.backgroundImage },
            this.boxShadow && {
              property: 'box-shadow',
              value: this.boxShadow,
              color: this.boxShadowColor
            },
            this.border && { property: 'border', value: this.border, color: this.borderColor },
            this.background && {
              property: 'background',
      ...
      const rgbToIntArray = (color) => [
        ...
        getStyleRule = ({ property: property, value: value }) => `${property}: ${value};`,
  ...
  `;
    ...
    <div class="code-section selectable-content">
      ${styles.map(CSSProperty)}
        ...
        CSSProperty = (cssProperty) => {
          const { property: property, value: value, color: color } = cssProperty;
    ...
    <span>${property}:</span>${coloredSquare}<span class="css-value">${value}</span>;</span>
        ...
        Outline = ({
          ...
          const { x: x, y: y, width: width, height: height } = node.absoluteBoundingBox,
            radius =
  ...
  `;
     ...
     */
      ...
      var ViewerMixin_decorate = function(decorators, target, key, desc) {
        ...
        ViewerMixin_classPrivateFieldSet = function(receiver, privateMap, value) {
          if (!privateMap.has(receiver))
            throw new TypeError('attempted to set private field on non-instance');
          return privateMap.set(receiver, value), value;
        };
          ...
          constructor(...args) {
            super(...args),
              ...
              _getNodeById.set(this, (id) => {
                ...
                return null !==
                  (_b =
                    null === (_a = ViewerMixin_classPrivateFieldGet(this, _flattenedNodes)) ||
                    void 0 === _a
                      ? void 0
            ...
            return extendStyles(super.styles, [
              css`
                :host {
                  ...
                  --guide-selected-color: var(--figspec-viewer-guide-selected-color, dodgerblue);
                  ...
                  --guide-tooltip-bg: var(--figspec-viewer-guide-tooltip-bg, var(--guide-color));
                  --guide-selected-tooltip-bg: var(
                    --figspec-viewer-guide-selected-tooltip-bg,
                    var(--guide-selected-color)
                  );
                  --guide-tooltip-font-size: var(--figspec-viewer-guide-tooltip-font-size, 12px);
          ...
          render() {
            if (this.error)
              return this.error instanceof Error
                ? ErrorMessage({ title: this.error.name || 'Error', children: this.error.message })
          ...
          >
            ${Object.entries(this.__images).map(([nodeId, uri]) => {
              ...
              if (
                ...
                !(null === (_a = ViewerMixin_classPrivateFieldGet(this, _effectMargins)) ||
                void 0 === _a
                  ? void 0
                  : _a[node.id])
              )
  ...
  `)({
            ...
            >
              ...
              ${ViewerMixin_classPrivateFieldGet(this, _flattenedNodes).map((node) => {
                var _a;
                return node.id ===
                  (null === (_a = this.selectedNode) || void 0 === _a ? void 0 : _a.id)
                  ? null
                  : svg`
                  <g>
                    ${Outline({
                      node: node,
                      computedThickness: computedGuideThickness * reverseScale,
                      onClick: ViewerMixin_classPrivateFieldGet(this, _handleNodeClick).call(
                        this,
                        node
                      )
                    })}
      ...
      `;
          ...
          __updateTree(node) {
            if ('CANVAS' !== node.type && 'FRAME' !== node.type && 'COMPONENT' !== node.type)
              throw new Error(
              ...
              'CANVAS' === node.type
                ? (function getCanvasSize(node) {
                    ...
                    for (const child of node.children) {
                      if ('FRAME' !== child.type && 'COMPONENT' !== child.type) continue;
                      const {
                        x: x,
                        y: y,
                        width: width,
                      ...
                      left.push(x), right.push(x + width), top.push(y), bottom.push(y + height);
                    }
          ...
          resetZoom() {
            if (ViewerMixin_classPrivateFieldGet(this, _canvasSize)) {
              const { width: width, height: height } = ViewerMixin_classPrivateFieldGet(
                  this,
                  _canvasSize
                ),
                { width: elementWidth, height: elementHeight } = this.getBoundingClientRect(),
      ...
      function getEffectMargin(container, nodes) {
        const points = nodes.map((node) => {
            ...
            const blurRadiuses = node.effects
                .filter((effect) => effect.visible && 'LAYER_BLUR' === effect.type)
                .map((effect) => effect.radius),
              shadowMargins = node.effects
                .filter(
                  (effect) => effect.visible && 'DROP_SHADOW' === effect.type && !!effect.offset
                )
                .map((effect) => ({
            ...
            return {
              ...
              right: node.absoluteBoundingBox.x + node.absoluteBoundingBox.width + margin_right,
        ...
        return {
          ...
          right:
            bounds_right - container.absoluteBoundingBox.x - container.absoluteBoundingBox.width,
          bottom:
            bounds_bottom - container.absoluteBoundingBox.y - container.absoluteBoundingBox.height,
      ...
      var FigspecFrameViewer_decorate = function(decorators, target, key, desc) {
        var d,
          c = arguments.length,
          r =
            c < 3
      ...
      var _selectFirstPage,
        ...
        FigspecFileViewer_classPrivateFieldGet = function(receiver, privateMap) {
          if (!privateMap.has(receiver))
            throw new TypeError('attempted to get private field on non-instance');
          return privateMap.get(receiver);
        };
                ...
                null !==
                  (_b =
                    null === (_a = this.documentNode) || void 0 === _a
                      ? void 0
                      : _a.document.children.find((c) => c.id === target.value)) && void 0 !== _b
                  ? _b
                  : null),
                this.selectedPage &&
          ...
          return extendStyles(super.styles, [
            css`
              :host {
                ...
                --control-bg: var(--figspec-control-bg, var(--figspec-control-bg-default));
                --control-fg: var(--figspec-control-bg, var(--figspec-control-fg-default));
                --control-shadow: var(--figspec-control-shadow, 0 2px 4px rgba(0, 0, 0, 0.3));
    ...
    `;
        ...
        connectedCallback() {
          super.connectedCallback(),
            this.documentNode &&
              ...
              this.selectedPage && (this.__updateTree(this.selectedPage), this.resetZoom()));
        }
        updated(changedProperties) {
          super.updated(changedProperties),
            changedProperties.has('documentNode') &&
              (FigspecFileViewer_classPrivateFieldGet(this, _selectFirstPage).call(this),
              this.selectedPage && (this.__updateTree(this.selectedPage), this.resetZoom())),
            changedProperties.has('renderedImages') && this.__updateEffectMargins();
        }
      }
      ...
      const bindEvent = (element, event, cb) => {
        ...
        es2015_FigspecFrameViewer = Object(react.forwardRef)((_a, ref) => {
          ...
          const refCb = Object(react.useCallback)((node) => {
            node && (setNode(node), (node.nodes = nodes), (node.renderedImage = renderedImage));
          }, []);
          return (
            Object(react.useEffect)(() => {
              refNode && ((refNode.nodes = nodes), (refNode.renderedImage = renderedImage));
            }, [refNode, nodes, renderedImage]),
            Object(react.useEffect)(() => {
              if (refNode && onNodeSelect) return bindEvent(refNode, 'nodeselect', onNodeSelect);
            ...
            Object(react.useEffect)(() => {
              if (refNode && onScaleChange) return bindEvent(refNode, 'scalechange', onScaleChange);
        ...
        es2015_FigspecFileViewer = Object(react.forwardRef)((_a, ref) => {
          ...
          return (
            Object(react.useEffect)(() => {
              refNode &&
                ((refNode.documentNode = documentNode), (refNode.renderedImages = renderedImages));
      ...
      var placeholder = __webpack_require__(303),
        core_browser_esm = __webpack_require__(16),
        Figma = __webpack_require__(442),
        ...
        fullscreen = Object(core_browser_esm.e)(
          templateObject_1 ||
      ...
      function unwrapJson(res) {
        return 200 !== res.status ? Promise.reject(res.statusText) : res.json();
      }
      var templateObject_1,
        Figspec = function(_a) {
          var config = _a.config,
            _b = Object(react.useState)({ state: 'loading' }),
            state = _b[0],
            setState = _b[1],
              ...
              return __awaiter(void 0, void 0, void 0, function() {
                ...
                return __generator(this, function(_b) {
                  switch (_b.label) {
                    ...
                    case 1:
                      if ((_b.trys.push([1, 6, , 7]), !(match = config.url.match(Figma.b))))
                        ...
                        !(accessToken = (function getAccessToken(cfg) {
                          ...
                          try {
                            return null !==
                              (_a = Object({
                                NODE_ENV: 'production',
                                NODE_PATH: ['/Users/ciemna_noc/Documents/Programming/okmr-ui'],
                                STORYBOOK: 'true',
                                PUBLIC_URL: '.',
                                SKIP_PREFLIGHT_CHECK: 'true'
                              }).STORYBOOK_FIGMA_ACCESS_TOKEN) && void 0 !== _a
                              ? _a
                              : null;
                          } catch (err) {
                            return null;
                      ...
                      return (
                        ...
                        nodeId
                          ...
                          : [
                              4,
                              fetch(nodeUrl.href, { headers: headers, signal: signal }).then(
                                unwrapJson
                              )
                            ]
                      );
                    case 2:
                      return (
                        ...
                        [
                          4,
                          fetch(imageUrl.href, { headers: headers, signal: signal }).then(
                            unwrapJson
                          )
                        ]
                      );
                    case 3:
                      return (
                        ...
                        setState({
                          ...
                          value: {
                            type: 'file',
                            props: { documentNode: documentNode, renderedImages: images_1.images }
                          }
                        }),
                        [2]
                      );
                    ...
                    case 5:
                      return (
                        ...
                        setState({
                          ...
                          value: {
                            type: 'frame',
                            props: { nodes: nodes, renderedImage: Object.values(images.images)[0] }
                          }
                        }),
                        [3, 7]
                      );
          ...
          switch (
            ...
            case 'loading':
              return Object(core_browser_esm.f)(
                placeholder.a,
                null,
                Object(core_browser_esm.f)(react.Fragment, null, 'Loading Figma file...')
              );
            case 'failed':
              return Object(core_browser_esm.f)(
                placeholder.a,
                null,
                Object(core_browser_esm.f)(react.Fragment, null, 'Failed to load Figma file'),
                Object(core_browser_esm.f)(react.Fragment, null, state.error)
              );
            case 'fetched':
              return 'file' === state.value.type
                ? Object(core_browser_esm.f)(
                    es2015_FigspecFileViewer,
                    __assign({ css: fullscreen }, state.value.props)
                  )
                : Object(core_browser_esm.f)(
                    es2015_FigspecFrameViewer,
                    __assign({ css: fullscreen }, state.value.props)
                  );
          }
        };
