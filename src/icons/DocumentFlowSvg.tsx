...
export const DocumentFlowSvg: React.FC = () => (
  <svg viewBox="0 0 32 32" width="20" height="20" fill="#A8CCFF" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M26.291,23.707l2,2C28.478,25.893,28.735,26,28.999,26c0.263,0,0.521-0.107,0.707-0.293l2-2
    ...
    />
    <path
      d="M26.239,28.24C25.145,29.332,23.65,30,21.999,30c-1.656,0-3.15-0.671-4.24-1.76
    ...
    />
    <path
      d="M2.999,32H14v-2H2.999C2.447,29.999,2,29.552,2,29V3c0-0.552,0.447-0.999,0.999-1H16v5
